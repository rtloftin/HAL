...
actor_fn = models.dense_sigmoid([2] + list(env.action_space.shape), hidden_layers=2, hidden_nodes=64)
critic_fn = models.dense_sigmoid([1], hidden_layers=2, hidden_nodes=64)
...
with ppo_ac as agent:
    benchmark(agent, env, episodes=20000, window=30)
